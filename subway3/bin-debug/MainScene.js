...
var MainScene = (function (_super) {
    ...
    MainScene.prototype.childrenCreated = function () {
        ...
        var scene = this.CreatedGroup(0, 0, scenewidth, sceneheight);
        //上方新信息栏
        var infowidth = this.getscreenWidth();
        var infoheight = this.getscreenHeight() * 0.1;
        var info = this.CreatedGroup(0, 0, infowidth, infoheight);
        scene.addChild(info);
        ...
        var content = this.CreatedGroup(0, infoheight, contentwidth, contentheight);
        ...
        var menu = this.CreatedGroup(0, contentheight + infoheight, menuwidth, menuheight);
        scene.addChild(menu);
        // var outline: egret.Shape = new egret.Shape;
        // outline.graphics.lineStyle(0, 0x000000);
        // outline.graphics.beginFill(0x6495ED, 0.5);
